...
from .session_manager import SessionManager, SessionNotFoundError, get_session_manager
...
async def list_sessions(
    ...
    try:
        ...
        session_responses = [SessionResponse(**session.session_info) for session in sessions]
